<?php
/**
 * Template Name: Print Startup
 *
 * Description: Page template for print cards team, project or both of startup
 *
 *
 * @package WordPress
 * @subpackage BuddyApp
...
// The variables
$project_print = htmlspecialchars($_POST['project-print']);
$team_print = htmlspecialchars($_POST['team-print']);
$complete_print = htmlspecialchars($_POST['complete-print']);
...
if( ($project_print && ($project_print == "print-project")) || ($complete_print && ($complete_print == "print-complete")) ){	// IF PROJECT SELECTED

				/**********  PROJECT PART  **********/ ?>
				
				<div class="big-title">Fiche Projet</div>
					...
					<div class="project-content-pitch competitor-resume-section">
						<div class="item-company competitor-resume">
							...
							while ( have_rows('competitor_resume') ) : the_row();
								...
								$clear_counter++;
								if( $clear_counter % 2 == 0 ) {	// Insert a clear:both every 2 float
...
<?php } // ENDIF print project

if( ($team_print && ($team_print == "print-team")) || ($complete_print && ($complete_print == "print-complete")) ){	// IF TEAM SELECTED
			...
			/************  TEAM PART  ************/ ?>
				...
				<div class="block-members">
					...
					<?php while( have_rows('members_team') ): the_row(); 
						...
						if (get_sub_field('usercheck_section_team')) :
							...
							if( $bio_id == 0 ) : // IF first member ?>
								<div class="first-member">
									<div class="big-title">Fiche Équipe</div>
										...
										<table class="table-header">
											<tr>
												...
												<td class="td-contacts">
													<div class="contacts">
													<?php if ($mail) : ?>
														<span class="span-contact"><i class="fa fa-envelope" aria-hidden="true"></i><?php echo $mail; ?></span>
													<?php endif; ?>
													<?php if ($phone) : ?>
														<span class="span-contact"><i class="icon-phone"></i><?php echo $phone; ?></span>
													<?php endif; ?>
													</div>
												</td>
											</tr>
									...
									<div class="bio-member">
										<div id="bio<?= $bio_id_used ?>" class="bio-content">
											<h3>Biographie</h3>
											<p><?php echo $bio; ?></p>
										</div>
									</div>
							...
							<?php else : // ELSE not first member ?>
								<div class="member-content">
									<?php
									if ($photo) {
									    $size = 'medium'; // (thumbnail, medium, large, full or custom size)
						...
						elseif ( !get_sub_field('usercheck_section_team') ) :
							...
							<?php if( $bio_id == 0 ) : // IF first member ?>
								<div class="first-member">
									<div class="big-title">Fiche Équipe</div>	
									<div class="member-content">
										<?php
				...
				<?php endif; // END of TEAM PART ?>

<?php } // ENDIF print team ?>

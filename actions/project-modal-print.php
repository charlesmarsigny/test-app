<?php
/**
 * Template Name: Project Print Modal 
 *
 * Description: Page template for choose print option for project
 *
 *
 * @package WordPress
 * @subpackage BuddyApp
		...
		<div class="choice-box">
			...
			<div class="choice-form">
				<form id="form-print-complete" class="form-print" action="/print" method="POST" target="_blank">
					...
					<a href="#projet" class="button-print" onclick="document.getElementById('form-print-complete').submit();">Imprimer</a>
				</form>
			</div>
		</div>
		<div class="choice-box">
			...
			<div class="choice-form">
				<form id="form-print-simplified" class="form-print" action="/print-simplified" method="POST" target="_blank">
					<input type="hidden" name="startup_id" value="<?php echo $startup_id; ?>" />
					<a href="#projet" class="button-print-secondary" onclick="document.getElementById('form-print-simplified').submit();">Imprimer</a>
				</form>
			</div>
		</div>
		<div class="choice-box">
			<div class="choice-description">
				<h3>Fiche projet</h3>
				<p>Uniquement les informations sur le projet de la startup.</p>
			</div>
			<div class="choice-form">
				<form id="form-print-project" class="form-print" action="/print" method="POST" target="_blank">
					<input type="hidden" name="startup_id" value="<?php echo $startup_id; ?>" />
					<input type="hidden" name="project-print" value="print-project" />
					<a href="#projet" class="button-print-secondary" onclick="document.getElementById('form-print-project').submit();">Imprimer</a>
				</form>
			</div>
		</div>
	</div>

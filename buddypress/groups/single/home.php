		...
		<div class="item-scroll-header">
			...
			<div id="item-nav">
				<div class="item-list-tabs no-ajax" id="object-nav" role="navigation">
					<style>
						#buddypress div#object-nav.item-list-tabs ul #nav-intentions-groups-li {
							<?php if ( bp_groups_get_group_type( bp_get_group_id() ) == 'closing' ) : ?>
								display: block;
							<?php else : ?>
								display: none;
							<?php endif; ?>
		 ...
		 */
			...
			if ( bp_is_group_home() ) :
				...
				if ( bp_group_is_visible() ) {
					...
					// do_action( 'blocked_group' );
					 ?>

					<div class="message-warning">
						<?php extend_bp_group_status_message(); ?>
					</div>
